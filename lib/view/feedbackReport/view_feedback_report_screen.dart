...
import 'package:road_safety/view/feedbackReport/feedbackReportDetail/feedback_report_detail_screen.dart';

class FeedbackreportScreen extends StatefulWidget {
  final String title;
  final String type;
  const FeedbackreportScreen({Key? key, required this.title, required this.type}) : super(key: key);
                                            ...
                                            onTap: () {
                                              ...
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(builder: (context) => FeedBackReportDetailScreen(
                                                  ...
                                                  screenTitle: widget.title.toString(),
