      ...
      body: Center(
        child: Container(
          ...
          child: ListView.builder(
            itemCount: DummyData.hospitalList.length,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  ClipRRect(
                            ...
                            child: Image.network(
                              DummyData.hospitalList[index].image.toString()
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          DummyData.hospitalList[index].name.toString()
                                          , style: TextStyle(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          DummyData.hospitalList[index].status.toString()
                                          , style: TextStyle(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.only(left: 8,),
                                        child: Text(
                                          DummyData.hospitalList[index].service.toString()
                                          , style: TextStyle(
                                            color: Colors.black, fontSize: 10, fontWeight: FontWeight.w500, height: 1.3,
                                            overflow: TextOverflow.ellipsis),overflow: TextOverflow.ellipsis,maxLines: 3,),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.only(left: 8,),
                                        child: Text(
                                          DummyData.hospitalList[index].address.toString()
                                          , style: TextStyle(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(left: 8,),
                                          child: Text(
                                            DummyData.hospitalList[index].phone.toString()
                                            , style: TextStyle(
